...
class AddNote extends StatefulWidget {
  const AddNote({super.key});// khóa quản lý các widget trong giao diện người dùng.
  @override
...
class _AddNoteState extends State<AddNote> { //Dòng này khai báo một lớp riêng tư tên là _AddNoteState kế thừa từ lớp State<AddNote>
  ...
  final FocusNode _focusNode1 = FocusNode(); //Focus cho biết TextField nào đang được người dùng nhập liệu.
  final FocusNode _focusNode2 = FocusNode();
  int indexx = 0; //kiểu int và khởi tạo giá trị bằng 0.
  @override
  Widget build(BuildContext context) {
    return Scaffold( //giàn giáo
      backgroundColor: Colors.white, //Cài đặt màu nền của màn hình
      body: SafeArea( //nội dung widget con tránh khỏi các notch hoặc camera cutout trên một số thiết bị.
        child: Column(  //tạo một widget Column xếp widget con theo chiều dọc
  ...
  Widget button() { //nút
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceAround, //sắp xếp các widget dọc theo một trục duy nhất
      children: [
        ElevatedButton( //nút thêm có hiệu ứng nhấp nhô
          ...
          onPressed: () { //thiết lập hành vi khi nút thêm được nhấn
            ...
            Navigator.pop(context);//đóng màn hình AddNote và quay lại màn hình trước
          },
        ...
        ElevatedButton(
          ...
          onPressed: () {
            Navigator.pop(context); //dùng để đóng (pop) màn hình thêm ghi chú và quay lại màn hình trước đó
          },
          child: const Text(
            'Cancel', // dạng hủy
            style: TextStyle(
  ...
  SizedBox imagess() { //ghi chú bằng ảnh
    return SizedBox(
      height: 180,
      child: ListView.builder( //danh sách cuộn ngang phù hợp với hiển thị màn hình
        itemCount: 4,
        scrollDirection: Axis.horizontal, //cuộn ngang
        itemBuilder: (context, index) { //mục danh sách.
          return GestureDetector( //Cho phép tương tác (bấm) vào mục để chọn ảnh.
            onTap: () { //chạm và nhả tay trên mục.
              setState(() { //cập nhật trạng thái của widget AddNote
                indexx = index;
              });
            },
            child: Padding( //Thêm khoảng đệm cho nội dung bên trong.
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          ...
                          fit: BoxFit.cover, //khớp nối ảnh lấp toàn bộ container.
                        ),
                      ),
                    ),
                      ...
                      index == 0
                          ...
                          : index == 1
                              ...
                              : index == 2
                                  ...
                                  : '#Other ',
                      style: TextStyle(
                        color: indexx == index ? Colors.black : Colors.grey, //index 0 1 2 black # grey
                        fontSize: 18,
                        fontWeight: FontWeight.w500,
                      ),
                    ),
  ...
  Widget titleWidgets() { //hiển thị tiêu đề đúng định dạng
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 15), //thêm khoảng cách xung quanh nội dung của một widget
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: TextField(
          ...
          controller: subtitle, //văn bản nhập vào được lưu trữ trong biến subtitle
