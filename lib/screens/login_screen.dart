...
là một tham số quan trọng trong Flutter giúp định danh các widget trong cây widget.*/
  ...
  State<LoginScreen> createState() =>
      _LoginScreenState(); // Tạo trạng thái cho widget.
}
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  @override
  void dispose() {
    // Phương thức hủy để giải phóng tài nguyên khi widget bị loại bỏ.
...
// Định nghĩa một phương thức bất đồng bộ tên `loginUser`
  ...
  Widget build(BuildContext context) {
    // Xây dựng giao diện người dùng cho màn hình đăng nhập.
    return Scaffold(
      // Sử dụng widget Scaffold để tạo khung cơ bản cho giao diện.
      backgroundColor: Colors.white, // Đặt màu nền của scaffold là màu trắng.
      body: Stack(
        // Thiết lập nội dung chính của scaffold là một widget Stack. Stack cho phép xếp chồng các widget lên nhau.
        fit: StackFit
            .expand, //Thiết lập fit của stack để phù hợp với kích thước của stack.
        children: [
          Positioned(
            // Widget Positioned được sử dụng để định vị một widget con ở một vị trí cụ thể trong stack.
            ...
            child: AnimatedOpacity(
              opacity:
                  opacityValue, // Thiết lập độ mờ của widget dựa trên giá trị của biến opacityValue.
              duration: const Duration(
                  seconds:
                      2), // Đặt thời gian mà hiệu ứng opacity sẽ diễn ra là 2 giây.
              child: Padding(
                // Sử dụng widget Padding để thêm khoảng trống xung quanh một widget con.
                padding: // Thiết lập khoảng trống ngang và dọc cho widget con là 15 pixels.
                    const EdgeInsets.symmetric(horizontal: 15, vertical: 15),
                child: Transform.rotate(
                  // Widget Transform.rotate được sử dụng để xoay một widget con với góc nhất định.
                  angle:
                      0.2, // Đặt góc xoay của widget con là 0.2 radians (khoảng 11.46 độ).
                  child: Container(
                    // Widget Container dùng để tạo một hộp chứa có thể được tùy chỉnh.
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                          color: Colors
                              .black), // Đặt viền container là một đường kẻ màu đen.
                      borderRadius: BorderRadius.circular(
                          40), // Bo tròn góc của container với bán kính 40 pixels.
                      ...
                      boxShadow: [
                        BoxShadow(
                          // Mỗi BoxShadow đại diện cho một hiệu ứng shadow cụ thể.
                    ...
                    child: const Padding(
                      // Sử dụng padding để tạo khoảng trống trong container để chứa nội dung.
                      // Thuộc tính padding định nghĩa kích thước của khoảng trống, ở đây là 20 pixels ở mỗi cạnh.
                      padding: EdgeInsets.all(20.0),
                      child: Column(
                        // Widget Column được sử dụng để xếp các widget con theo hướng dọc.
                        ...
                        children: [
                          Row(
                            // Widget Row được sử dụng để xếp các widget con theo hướng ngang.
                            ...
                            children: [
                              Expanded(
                                // Widget Expanded mở rộng widget con để nó sử dụng tất cả không gian còn trống trong hàng.
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize:
                                        30, // Đặt kích thước của văn bản là 30 pixels.
                                    fontWeight: FontWeight
                                        .w400, // Xác định độ đậm của văn bản (FontWeight.w400 tương ứng với font chữ regular).
                                    color: Colors
                                        .black, // Đặt màu chữ của văn bản là đen.
                                  ),
                                ),
                              ),
                            ],
          ...
          Positioned(
            ...
            child: AnimatedOpacity(
              ...
              child: Padding(
                // Widget Padding được sử dụng để tạo một khoảng trống xung quanh nội dung của nó.
                ...
                child: Transform.rotate(
                  ...
                  angle: -0.1,
                  child: Container(
                    // Widget Container dùng để chứa và vẽ nội dung.
                    ...
                    child: const Padding(
                      ...
                      padding: EdgeInsets.all(20.0),
                      child: Column(
                        // Đây là một child widget của container, một Column được sử dụng để xếp các widget con theo hướng dọc.
                        // Đặt các widget con bắt đầu từ bên trái của Column.
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Xác định danh sách các widget con của Column
                          Row(
                            // Xếp các widget con theo hướng ngang.
                            // Đặt các widget con sao cho chúng được căn chỉnh một cách đều đặn theo chiều dọc,
                            // với khoảng trống đều nhau
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              // Xác định danh sách các widget con của Row
                              Expanded(
                                // Để sử dụng không gian còn trống trong Row.
                                child: Text(
                                  '#TODO: Add some tasks',
                                  maxLines: 2,
                                  overflow: TextOverflow.ellipsis,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Tạo ra một khoảng trống dọc có chiều cao là 1 pixels
